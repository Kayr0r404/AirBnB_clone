...
class TestBaseModel(unittest.TestCase):
    ...
    def test_str(self):
        ...
        expectStr = f"[{n}] ({self.base_model.id}) <{self.base_model.__dict__}>"
        self.assertEqual(self.base_model.__str__(), expectStr)
    ...
    def test_toDict(self):
        ...
        self.assertEqual(baseModelDict['__class__'],
                         "BaseModel")
        self.assertEqual(baseModelDict['created_at'],
                         base_model.created_at.isoformat())
        self.assertEqual(baseModelDict["updated_at"],
